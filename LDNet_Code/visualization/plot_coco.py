...
def parse_args():
    ...
    parser.add_argument('--image-path',
                        ...
                        type=str,
                        default='/mnt/xudingning/HRNet/data/coco/images/val2017/'
                        )

    parser.add_argument('--gt-anno',
                        help='Path of COCO val annotation',
                        type=str,
                        default='/mnt/xudingning/HRNet/data/coco/annot/person_keypoints_val2017.json'
                        )
    ...
    parser.add_argument('--prediction',
                        ...
                        type=str,
                        default='/mnt/xudingning/HRNet/tools/output/coco/coco-w48-ia/results/keypoints_val2017_results_0.json')
