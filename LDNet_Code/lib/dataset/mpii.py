...
class MPIIDataset(JointsDataset):
    ...
    def _get_db(self):
        ...
        for a in anno:
            ...
            gt_db.append(
                {
                    'image': os.path.join('/mnt/xudingning/HRNet/data/mpii', image_dir, image_name),
                    'center': c,
                    'scale': s,
                    'joints_3d': joints_3d,
    ...
    def evaluate(self, cfg, preds, output_dir, *args, **kwargs):
        ...
        gt_file = os.path.join('/mnt/xudingning/HRNet/data/mpii/annot/gt_valid.mat')
        ...
        head_test = np.where(dataset_joints == 'head')
